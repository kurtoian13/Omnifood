...
<body>
    ...
    <footer>
        <div class="row">
            ...
            <div class="row">
                <p>Copyright &copy; 2020 KODESIGNS (omnifood Project). All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-48DM0WWC3H"></script>
    <script>
